...
public class Doctor {
	...
	public ArrayList<Message> getMessages(String username, String contact) {
		String contactFolderPath = Database.getContactFolderPath("doctor", username, contact, "sent");
		int numberOfMessages = Database.getNumberOfMessages("doctor", username, contact, "sent");
	...
	public ArrayList<Message> getReceivedMessages(String doctorUsername, String senderUsername) {
		String contactFolderPath = Database.getContactFolderPath("doctor", doctorUsername, senderUsername, "received");	
		int numberOfMessages = Database.getNumberOfMessages("doctor", doctorUsername, senderUsername, "received");
		int decrementVariable = numberOfMessages;
		
		for (int i = 0; i < numberOfMessages; i++) {
			String contactFileName = contactFolderPath + File.separator + senderUsername + "To" + doctorUsername + "_" + decrementVariable + "Message.txt" ; 
			try (Scanner scanner = new Scanner(new File(contactFileName))) {
				String timeString = null;
				String recipient = null;
				String subj = null;
